...
import newsBlog4 from "@/assets/images/About-Us/news-blog-4.png";
import newsBlog5 from "@/assets/images/About-Us/news-blog-5.png";
import newsBlog6 from "@/assets/images/About-Us/news-blog-6.png";
import newsBlog1 from "@/assets/images/home-1/news-blog-1.png";
import newsBlog2 from "@/assets/images/home-1/news-blog-2.png";
import newsBlog3 from "@/assets/images/home-1/news-blog-3.png";
...
const BlogGrid = () => {
  return (
    <>
      {/* <!-- news-blog --> */}
      <div className="news-blog bg-texture bg-no-repeat bg-cover bg-center fade-in overflow-hidden">
        <div className="pt-[70px] md:pt-[140px] relative">
          <div className="img-2 absolute -bottom-[16rem] left-0 -z-10">
            <Image src={shape} alt="decor shape" />
          </div>
          <div className="container pb-[140px]">
            <div className="grid grid-cols-12 gap-4 md:gap-[30px]">
              <div className="col-span-12 text-center mb-10 md:mb-[70px]">
                ...
                <h1 className="skew-up title font-plus-jakarta-sans font-semibold text-white">
                  Get Every Single Updates
                </h1>
              </div>
              <div
                className="col-span-12 md:col-span-6 lg:col-span-4 bg-Dark-Cyan-Green rounded-bl-[16px] rounded-br-[16px] wow bounceInLeft"
              ...
              >
                <div className="img relative mb-[18px] md:mb-[35px] wow overlay-anim zoom-effect overflow-hidden">
                  ...
                  <div className="date absolute top-[18px] right-[18px] bg-International-Orange rounded-[3px] flex flex-col items-center justify-center py-[13px] px-5">
                    <span className="font-jost font-medium text-[18px] md:text-[24px] leading-[34px] text-white">
                      25
                    </span>
                    <span className="font-jost font-normal text-[14px] md:text-base leading-[23px] text-white">
                      Sep
                    </span>
                  </div>
                </div>
                <div className="content px-3 md:px-[30px] pb-[20px] md:pb-[34px] border-b border-white/10 mb-5">
                  ...
                  <Link
                    ...
                    className="block font-plus-jakarta-sans font-semibold text-[14px] lg:text-[16px] xl:text-[21px] leading-[30px] text-white"
                  >
              ...
              <div
                className="col-span-12 md:col-span-6 lg:col-span-4 bg-Dark-Cyan-Green rounded-bl-[16px] rounded-br-[16px] wow bounceInUp"
                data-wow-duration="1s"
                data-wow-delay="1s"
              >
                <div className="img relative mb-[18px] md:mb-[35px] wow overlay-anim zoom-effect overflow-hidden">
              ...
              <div
                className="col-span-12 md:col-span-6 lg:col-span-4 bg-Dark-Cyan-Green rounded-bl-[16px] rounded-br-[16px] wow bounceInRight"
                data-wow-duration="1s"
                data-wow-delay="1.5s"
              >
                <div className="img relative mb-[18px] md:mb-[35px] wow overlay-anim zoom-effect overflow-hidden">
