...
import { chefData } from "../data/chefCardData";
import ChefCard from "./ChefCard";

const MeetOurExclusive = () => {
  ...
  return (
    <>
      <div className="meet-our-exclusive bg-texture bg-no-repeat bg-cover bg-center py-[70px] md:pt-[135px] md:pb-[139px] overflow-hidden fade-in">
        <div className="container">
          <div className="grid grid-cols-12 gap-6">
            <div className="col-span-12 text-center mb-5 md:mb-[73px]">
              <h2 className="section-subtitle font-satisfy font-normal subtitle text-Beer flex items-center justify-center gap-[15px]">
                <span>
                  <svg
                    width="13"
                    height="30"
              ...
              <h1 className="title font-plus-jakarta-sans font-semibold text-white split-collab">
                Skyline Culinary Masters
              </h1>
            </div>
...
export default MeetOurExclusive;
